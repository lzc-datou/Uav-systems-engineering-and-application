...
#define MPU_SAMPLE_RATE_REG		0X19	// Sampling prescaler
#define MPU_CFG_REG						0X1A
#define MPU_GYRO_CFG_REG			0X1B	// Gyro configuration
#define MPU_ACCEL_CFG_REG			0X1C	// Acc configuration
...
#define MPU_ACCEL_XOUTH_REG		0X3B	// acc x 15:8
#define MPU_ACCEL_XOUTL_REG		0X3C	// acc x 7:0
#define MPU_ACCEL_YOUTH_REG		0X3D	// acc y 15:8
#define MPU_ACCEL_YOUTL_REG		0X3E	// acc 7 7:0
#define MPU_ACCEL_ZOUTH_REG		0X3F	// acc z 15:8
#define MPU_ACCEL_ZOUTL_REG		0X40	// acc z 7:0

#define MPU_TEMP_OUTH_REG			0X41	// temp 15:8
#define MPU_TEMP_OUTL_REG			0X42	// temp 7:0

#define MPU_GYRO_XOUTH_REG		0X43	// gyro x 15:8
#define MPU_GYRO_XOUTL_REG		0X44	// gyro x 7:0
#define MPU_GYRO_YOUTH_REG		0X45	// gyro y 15:8
#define MPU_GYRO_YOUTL_REG		0X46	// gyro y 7:0
#define MPU_GYRO_ZOUTH_REG		0X47	// gyro z 15:8
#define MPU_GYRO_ZOUTL_REG		0X48	// gyro z 7:0
...
#define MPU_PWR_MGMT1_REG			0X6B	// Power manager 1
#define MPU_PWR_MGMT2_REG			0X6C	// Power manager 2
#define MPU_FIFO_CNTH_REG			0X72
#define MPU_FIFO_CNTL_REG			0X73
#define MPU_FIFO_RW_REG				0X74
#define MPU_DEVICE_ID_REG			0X75	// 0x68(AD0->GND)/0x69(AD0->VCC)
